# Tutoriel rapide — Boutons du briefing

## 1) Sauvegarder
Enregistre l'état actuel du briefing pour pouvoir le retrouver plus tard.

## 2) Effacer
Supprime l'état enregistré localement et remet le briefing à zéro.

## 3) Restaurer
Recharge la dernière sauvegarde pour reprendre rapidement la session.
